...
class ReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'REPO-S002' do
    assert_difference('Report.count') do
      post reports_url,
           params: { report: { category: @report.category, content: @report.content, title: @report.title, user_id: @report.user_id } }, headers: { Authorization: @token }, as: :json
    end
  ...
  test 'REPO-E002' do
    post reports_url,
         params: { report: { category: @report.category, content: @report.content, title: @report.title, user_id: @report.user_id } }, as: :json
    assert_response 401
  end
